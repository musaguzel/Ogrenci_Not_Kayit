...
namespace NotKayıtProje {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TBLNOTLARDataTable : global::System.Data.TypedTableBase<TBLNOTLARRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TBLNOTLARRow AddTBLNOTLARRow(int OGRENCIID, byte SINAV1, byte SINAV2, byte SINAV3, byte PROJE, decimal ORTALAMA, bool DURUM, string DERSAD) {
...
namespace NotKayıtProje.DataSet1TableAdapters {
    ...
    public partial class TBLDERSLERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::NotKayıtProje.Properties.Settings.Default.OkulProjeConnectionString;
        }
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT        TBLOGRENCİLER.OGRID, TBLOGRENCİLER.OGRAD, TBLOGRENCİLER.OGRSOYAD, T" +
                "BLKULUPLER.KULUPAD, TBLOGRENCİLER.OGRCINSIYET\r\nFROM            TBLOGRENCİLER INN" +
                "ER JOIN\r\n                         TBLKULUPLER ON TBLOGRENCİLER.OGRKULUP = TBLKUL" +
                "UPLER.KULUPID";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT        TBLOGRENCİLER.OGRID, TBLOGRENCİLER.OGRAD, TBLOGRENCİLER.OGRSOYAD, TBLKULUPLER.KULUPAD, TBLOGRENCİLER.OGRCINSIYET
FROM            TBLOGRENCİLER INNER JOIN
                         TBLKULUPLER ON TBLOGRENCİLER.OGRKULUP = TBLKULUPLER.KULUPID
WHERE        (TBLOGRENCİLER.OGRAD = @OGRAD)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "INSERT INTO TBLOGRENCİLER\r\n                         (OGRAD, OGRSOYAD, OGRKULUP, O" +
            ...
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "UPDATE       TBLOGRENCİLER\r\nSET                OGRAD = @OGRAD, OGRSOYAD = @OGRSOY" +
            ...
            this._commandCollection[4].CommandText = "DELETE FROM TBLOGRENCİLER\r\nWHERE        (OGRID = @OGRID)";
    ...
    public partial class TBLNOTLARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        TBLDERSLER.DERSAD, TBLNOTLAR.OGRENCIID, TBLNOTLAR.SINAV1, TBLNOTLAR.SINAV2, TBLNOTLAR.SINAV3, TBLNOTLAR.PROJE, TBLNOTLAR.ORTALAMA, TBLNOTLAR.DURUM, TBLNOTLAR.NOTID
FROM            TBLNOTLAR INNER JOIN
                         TBLDERSLER ON TBLNOTLAR.DERSID = TBLDERSLER.DERSID
WHERE        (TBLNOTLAR.OGRENCIID = @OGRENCIID)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
